...
String RemoteCenterName=request.getParameter("RemoteCenterID");
...
System.out.println(RemoteCenterName);
int remoteCenterID= dbqueries.getRemoteCenterIDForInsert(conn, RemoteCenterName, rcid);
System.out.println(remoteCenterID);
//int remoteCenterID=dbqueries.getRemoteCenterIDForInsert(conn, RemoteCenterName);
boolean flag=false;
flag=dbqueries.insertCoordinatorDetail(conn, remoteCenterID, Username, Password, email);
System.out.println("Successfully inserted value ...." +flag);
}
catch (Exception e) {
...
<h1 style="font-size: 32px">You have sucessfully registered</h1>
<div style="height: 30px"></div>
