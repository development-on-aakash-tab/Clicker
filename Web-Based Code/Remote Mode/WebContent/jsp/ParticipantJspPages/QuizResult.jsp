...
<meta http-equiv="Refresh" content="5;url=../../jsp/ParticipantJspPages/QuizResultSSE.jsp">
</head>
<body>
<center>
	...
	<div id="content_in">
		...
		<%
		System.out.println("Qvector size - tempQResponse length : " + Questiondetails.size() + " - " +temp_questionsResponse.length + " - " +ParticipantID);
		
		System.out.println("Is both size are same ---------------------"+ (Questiondetails.size() == temp_questionsResponse.length));
