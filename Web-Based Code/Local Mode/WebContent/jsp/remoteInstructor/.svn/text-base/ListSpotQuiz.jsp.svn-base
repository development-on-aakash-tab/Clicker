...
Vector<Quiz> Quiz_Details = dbqueries.getSpotQuizIDName(conn, CourseID,InstructorID);
%>
<html>
<head>
...
<title>Aakash Remote Clicker Quiz</title>
</head>
<body>
...
%>
			...
			<br /> <input type="button" value="Conduct Quiz"
				onclick="showQuizdlg(QuizNameSelect.value);" />
		</div>
	</form>
</body>
</html>