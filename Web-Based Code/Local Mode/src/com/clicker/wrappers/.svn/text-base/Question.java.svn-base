...
public class Question {
	...
	/**
	 * This method set the Template for a Question
	 * 
	 * @param t
	 *            Template to set
	 */
	public void setTemplate(char t) {
		template = t;
	}

	/**
	 * This method set the Course id and course name
	 * 
	 * @param id
	 *            Course id to set
	 * @param name
	 *            Course name to set
	 */
	public void setCourse(String id, String name) {
		course = new Course();
	...
	/**
	 * This method set the Question Credit
	 * 
	 * @param id
	 *            Question credit to set
	 */
	public void setCredit(float id) {
		Credit = id;
		System.out.println("Credit in setCredit Func : " + Credit);
	}

	/**
	 * This method add a option to the list of option
	 * 
	 * @param op
	 *            Question name to set
	 */
	...
	/**
	 * This method is used to get Course class object for get course information
